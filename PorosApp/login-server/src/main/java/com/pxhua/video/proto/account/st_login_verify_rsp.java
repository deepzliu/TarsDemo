...
@TarsStruct
public class st_login_verify_rsp {
	...
	public st_login_verify_rsp() {
	}

	public st_login_verify_rsp(int ret, String msg, long uid) {
		this.ret = ret;
		this.msg = msg;
		this.uid = uid;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof st_login_verify_rsp)) {
			return false;
		}
		st_login_verify_rsp other = (st_login_verify_rsp) obj;
		return (
