...
@TarsStruct
public class st_token_verify_req {
	...
	public st_token_verify_req() {
	}

	public st_token_verify_req(int token_mode, com.pxhua.video.proto.commondef.st_user_info user_info, java.util.Map<String, String> cookie, int platform, int client_type) {
		this.token_mode = token_mode;
		this.user_info = user_info;
		this.cookie = cookie;
		this.platform = platform;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof st_token_verify_req)) {
			return false;
		}
		st_token_verify_req other = (st_token_verify_req) obj;
		return (
